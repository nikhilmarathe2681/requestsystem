...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        ...
        <!-- Image Logo -->
        <a class="navbar-brand logo-image" href="index.html"><img src="images/techno.jpg"  width="300" height="300" alt="alternative"></a>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="text-container">
                            ...
                            <p class="p-large">The database is firewood of Marketing; the right database is at the head of better marketing activity.

                                It saves the time of hunting targeted or prospective audience.
                                
                                We lend data monetization, easy acquisition, and data secure and accessible to all.
                                
                                You can get the required source based on your targeted audience and location.</p>
    ...
    <h3>About Us</h3>
    <p>Our database provider solution is high quality for many business and telemarketing activities. Not all database providing companies are transparent about their bulk database to generate excellent sales lead. Truecaller verified mobile number database provider shall help you to achieve the right target audience for your services and products in India.</p>
    <p>The Ebase Database Service makes it easy to set up, operate, and scale a relational database in the cloud. It provides cost-efficient and resizable capacity while automating time-consuming administration tasks such as hardware provisioning, database setup, patching and backups. It frees you to focus on your applications so you can give them the fast performance, high availability, security and compatibility they need.

        Ebase is available on several database instance types - optimized for memory, performance or I/O - and provides you with six familiar database engines to choose from, including Amazon Aurora, PostgreSQL, MySQL, MariaDB, Oracle Database, and SQL Server. You can use the AWS Database Migration Service to easily migrate or replicate your existing databases to Amazon RDS.</p>
    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <hr>
                    <h5>Core feature</h5>
                    <p>Ebase is a managed relational database service that provides you six familiar database engines to choose from, including Amazon Aurora, MySQL, MariaDB, Oracle, Microsoft SQL Server, and PostgreSQL. This means that the code, applications, and tools you already use today with your existing databases can be used with Amazon RDS. Amazon RDS handles routine database tasks such as provisioning, patching, backup, recovery, failure detection, and repair.

                        Ebase RDS makes it easy to use replication to enhance availability and reliability for production workloads. Using the Multi-AZ deployment option, you can run mission-critical workloads with high availability and built-in automated fail-over from your primary database to a synchronously replicated secondary database. Using Read Replicas, you can scale out beyond the capacity of a single database deployment for read-heavy database workloads.</p>
                    <ul class="list-unstyled li-space-lg">
                        <li class="media">
                            <i class="fas fa-check"></i><div class="media-body">All Indian database</div>
                        </li>
                        <li class="media">
                            <i class="fas fa-check"></i><div class="media-body">Easy database browsing</div>
                        </li>
                        <li class="media">
                            <i class="fas fa-check"></i><div class="media-body">Different facilities</div>
                        </li>
                        <li class="media">
               ...
               class="text-center">
                  <div class="container">
                        <form method="post" class="form-signin">
                          ...
                          <label for="inputPassword" class="sr-only">Interest In...</label>  
                          <input name="interest" type="interest" id="inputEmail" class="form-control" placeholder="interest" required autofocus>
                          ...
                          <button name="signup" class="btn btn-lg btn-primary btn-block" type="submit">Request</button>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="list-unstyled li-space-lg">
                        ...
                        <li><i class="fas fa-envelope"></i><a class="turquoise" href="marathe2681@gmail.com">0fficeTheEbase@gmail.com</a></li>
                    </ul>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            <div class="row">
